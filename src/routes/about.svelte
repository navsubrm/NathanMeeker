...
<div in:fly={{ y: -100, duration: 500, delay: 400 }} out:fade>
	<SubPageTitleBar title={'about'} colorVar={'rgb(151, 202, 239)'} />
	<div class="container-border">
		<div class="center">
			...
			<p>
				...
				> and have been working on my MBA with an emphasis in technology Management. Recently, over the
				last couple of years, I have invested considerable time developing custom MS SharePoint solutions
				to support tele-work changes occurring from the COVID-19 pandemic.
			</p>
		</div>
	</div>
</div>
